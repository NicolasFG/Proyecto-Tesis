...
from keras_maskrcnn import models as maskrcnn_models
...
# Generar ROIs
rois = model.predict_on_batch(images)

# Componente de clasificación
classification_model = maskrcnn_models.MaskRCNNClassification(num_classes=train_generator.num_classes())
classification_output = classification_model(rois)

# Componente de segmentación
segmentation_model = maskrcnn_models.MaskRCNNSegmentation()
segmentation_output = segmentation_model(rois)

# Realizar las tareas de clasificación y segmentación en las ROIs
classification_predictions = classification_output.predictions
segmentation_predictions = segmentation_output.predictions
